...
def load_data():
    f = open('practice/Unsupervised_Learning/q6/data/iris.csv', 'r', encoding='utf-8')
    raw_data = csv.reader(f)
    
    # 붓꽃 데이터를 한 줄씩 읽어와 float 형으로 빈 리스트 sepal_length, sepal_width에 저장합니다.
    # 데이터의 이름 표지 'sepal_length', 'sepal_width'는 list에 포함하지 않습니다.
    ...
    return np.stack((sepal_length, sepal_width), axis = 1)