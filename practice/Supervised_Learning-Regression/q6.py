...
def plot_graph(coef, title, filename):
    fig = plt.figure()
...
def main():
    ...
    plot_graph(ridge_coef, 'Ridge', "practice\Supervised_Learning-Regression\q6_ridge.png")
    plot_graph(lasso_coef, 'Lasso', "practice\Supervised_Learning-Regression\q6_lasso.png")
